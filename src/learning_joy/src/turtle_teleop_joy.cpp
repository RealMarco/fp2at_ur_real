...
TeleopTurtle::TeleopTurtle(): linear_(0), angular_(1)  // 代表哪个轴
{
...
void TeleopTurtle::joyCallback(const sensor_msgs::Joy::ConstPtr& joy)
{
  ...
  cout << twist.angular.z << " " << twist.linear.x << endl;
  cout << joy->axes[angular_] << " " << joy->axes[linear_] << " "<< joy->buttons[0]<< " " << joy->buttons[4]<< endl;
